...
(deftest chain-tests
  (is (= (chain (i/int-map 0 7, 1 5, 10 3, 11 2)
                (i/int-map 0 7, 1 5, 10 3, 11 2))
         '({0 168, 1 316, 2 196, 3 40, 10 54, 11 108, 12 72, 13 16}
           {0 420, 1 250, 10 488, 11 300, 20 188, 21 120, 30 24, 31 16})))
  (is (= (chain (i/int-map 1 5, 11 2)
                (i/int-map 10 4, 21 1))
         '({1 20, 2 10, 11 32, 12 26, 22 24, 23 4, 33 4}
           {10 100, 20 80, 21 25, 30 36, 31 20, 40 8, 41 9, 51 2})))
  (is (= (chain (i/int-map 10 4, 21 1)
                (i/int-map 1 5, 11 2))
         '({1 80, 2 40, 3 100, 4 50, 11 32, 12 56, 13 80, 14 90, 22 16, 23 16, 24 48, 34 8}
...
(deftest div-tests
  (is (= (div [(i/int-map 433 5) (i/int-map 212 8) (i/int-map 40 1)])
         {202 8, 333 20}))
  (is (= (div (curl [(i/int-map 433 5) (i/int-map 212 8) (i/int-map 40 1)]))
         {})))

(deftest curl-tests
  (is (= (curl [(i/int-map 433 5) (i/int-map 212 8) (i/int-map 40 1)])
         '({30 4, 211 -16} {432 15} {112 16, 423 -15})))
  (is (= (curl (grad (i/int-map 3 2, 40 1, 100 5, 212 8)))
         '({} {} {}))))
